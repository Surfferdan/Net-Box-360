...
public sealed class WindowsFilePickerService : IFilePickerService
{
	public string? PickExecutable()
	{
		...
		{
			Title = "Choose game executable or shortcut",
			Filter = "Executables and shortcuts (*.exe;*.lnk;*.url)|*.exe;*.lnk;*.url|Windows executables (*.exe)|*.exe|Windows shortcuts (*.lnk;*.url)|*.lnk;*.url|All files (*.*)|*.*",
